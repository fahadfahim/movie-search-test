    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 gap-[20px] h-fit '>
            ...
            <div className='border p-2 rounded-lg'>
                <h1 className='text-[28px] font-bold dark:text-white text-[#121212]'>{movie?.title}</h1>
                ...
                <div className='flex text-sm font-bold dark:text-white text-[#121212]'>Geners :{movie?.genres?.map((gener: any) => <p className='text-sm font-bold text-[#121212]' key={gener?.id}> {gener?.name} {', '}</p>)}</div>
                <p className='text-[18px] dark:text-white text-[#121212] font-bold my-2'>Cast : </p>
